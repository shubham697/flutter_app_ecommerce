import 'dart:io';
import 'package:flutterstore/ui/product/detail/views/terms_and_policy_tile_view.dart';
...
import 'package:flutterstore/ui/terms_and_conditions/terms_and_conditions_view.dart';
    ...
    return WillPopScope(
      ...
      child: Scaffold(
          ...
          appBar: AppBar(
            ...
            //           SearchProductProvider(repo: productRepository);
          ...
          bottomNavigationBar: _currentIndex ==
            ...
            child: BottomNavigationBar(
              ...
              //selectedItemColor: PsColors.textPrimaryColor,
              fixedColor: PsColors.textPrimaryColor,
              unselectedItemColor: PsColors.textPrimaryColor,
              iconSize: 20,
              selectedFontSize:12,
...
class __DrawerMenuWidgetState extends State<_DrawerMenuWidget> {
  ...
  Widget build(BuildContext context) {
    return ListTile(
        leading: Icon(widget.icon, color: PsColors.textPrimaryColor),
        title: Text(
          widget.title,
          style: Theme.of(context).textTheme.bodyText2,
        ),
...
class _DrawerHeaderWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return DrawerHeader(
      ...
      decoration: BoxDecoration(color: PsColors.headerColor),
    );
  }
}
